...
void colorX(double x[], renRenderer *ren, double unif[], texTexture *tex[], 
    ...
    double alpha[6] = {a[renVARYS], a[renVARYT], a[renVARYZ], a[renVARYN], a[renVARYO], a[renVARYP]};
    double beta[6] = {b[renVARYS], b[renVARYT], b[renVARYZ], b[renVARYN], b[renVARYO], b[renVARYP]};
    double gamma[6] = {c[renVARYS], c[renVARYT], c[renVARYZ], c[renVARYN], c[renVARYO], c[renVARYP]};
    double alphaBeta[6];
    double alphaGamma[6];
    vecSubtract(6, beta, alpha, alphaBeta);
    vecSubtract(6, gamma, alpha, alphaGamma);
    vecScale(6, pq[0], alphaBeta, alphaBeta);
    vecScale(6, pq[1], alphaGamma, alphaGamma);
    vecAdd(6, alphaBeta, alphaGamma, st);
    vecAdd(6, st, alpha, st);
    vary[renVARYS] = st[0];
    vary[renVARYT] = st[1];
    vary[renVARYZ] = st[2];
    vary[renVARYN] = st[3];
...
void triRender(renRenderer *ren, double unif[], texTexture *tex[], double aVary[], double bVary[], double cVary[]) {
    ...
    double NOP[3] = {aVary[renVARYN], aVary[renVARYN], aVary[renVARYN]};
